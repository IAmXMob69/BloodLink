...
Hearth is a self-hosted chat server. Treat an instance like email:
...
- The default SQLite file lives in `server/data/hearth.db` (or the Electron user-data directory). Back it up; it is the whole server.
